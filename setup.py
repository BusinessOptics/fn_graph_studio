...
setup(
    ...
    install_requires=['dash==1.*,>=1.0.0', 'dash-ace-persistent==0.*,>=0.3.4', 'dash-core-components==1.*,>=1.0.0', 'dash-cytoscape==0.*,>=0.1.1', 'dash-dangerously-set-inner-html==0.*,>=0.0.2', 'dash-interactive-graphviz==0.*,>=0.0.0', 'dash-split-pane==1.*,>=1.0.0', 'dash-treebeard==0.*,>=0.0.1', 'fn-graph[examples]==0.*,>=0.14.0', 'matplotlib==3.*,>=3.2.1', 'networkx==2.*,>=2.4.0', 'pandas>=0.25.3', 'plotly==4.*,>=4.0.0', 'pygments==2.*,>=2.6.1', 'seaborn==0.*,>=0.10.0', 'sh==1.*,>=1.0.0', 'statsmodels==0.*,>=0.11.1'],
